namespace Pager
{
	...
	public class PagerViewController : UIViewController
	{
        ...
        public PagerViewController(PagerStyle style, int varianza,params UIViewController[] children)
		{
        ...
        public void OnPageSwiped(object sender, UIPageViewFinishedAnimationEventArgs e)
		{
			if (e.Completed)
			{
                ...
                if (index == 1 || index == 2)
                {
                    Action a = () =>
                    {
                        pagerView.Frame = new CGRect(0, this.style.BarHeight + varianza, this.View.Bounds.Width, this.View.Bounds.Height - this.style.BarHeight);
